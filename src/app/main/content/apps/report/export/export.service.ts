...
export class ExportService implements Resolve<any>
{
    ...
    FilterReportExports(tableId): Promise<any> {

        return new Promise((resolve, reject) => {
            this.http.get(urlconstants.apiurl + 'reports/filterreportexports/' + tableId, this.options)
                .subscribe((response: any) => {
    ...
    CreateExport(formdata, exportdata): Observable<any> {
        // return new Promise((resolve, reject) => {
        //     debugger;
        //     this.http.post(urlconstants.apiurl + 'reports/Createexport', { formdata: formdata, exportdata: exportdata })
        //         .subscribe((response: any) => {
        //             resolve(response);
        //         }, reject);
        // });
        return this.http.post(urlconstants.apiurl + 'reports/Createexport', { formdata: formdata, exportdata: exportdata }, this.options);
    };
